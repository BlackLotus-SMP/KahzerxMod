    ...
    public void getSubCommands(LiteralArgumentBuilder<ServerCommandSource> command, CommandRegistryAccess commandRegistryAccess, ScoreboardExtension scoreboard, boolean persistent) {
        command.
                ...
                then(literal("killed_by").
                        then(argument("entity", RegistryEntryArgumentType.registryEntry(commandRegistryAccess, RegistryKeys.ENTITY_TYPE)).
                                suggests(SuggestionProviders.SUMMONABLE_ENTITIES).
                                executes(context -> scoreboard.startThreadedKilledScoreboard(context.getSource(), RegistryEntryArgumentType.getSummonableEntityType(context, "entity"), "killed_by", persistent)))).
                then(literal("deaths").
                ...
                then(literal("trades").
                        executes(context -> scoreboard.startThreadedCommandScoreboard("K.villager_trades", "villager trades", "scoreboard objectives add K.villager_trades minecraft.custom:minecraft.traded_with_villager", context.getSource(), Stats.TRADED_WITH_VILLAGER, persistent))).
                then(literal("cm_pig").
