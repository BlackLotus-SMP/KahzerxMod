...
public class Parcel {
    ...
    public MutableText formatted(ShopExtension extension) {
        ...
        MutableText t = MarkEnum.INFO.appendMsg(String.format("coords: §7%d %d§r owner: §7%s§r", centerX, centerZ, ownerUUID != null ? extension.getDB().getQuery().getPlayerName(ownerUUID) : "None"));
