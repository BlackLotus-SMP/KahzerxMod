...
public class MainGui extends GuiBase {
    ...
    private final ImageBack cornerBR;
    private final ImageBack cornerBL;
    private final ImageBack cornerTR;
    private final ImageBack cornerTL;
    private final ImageBack boxTL;
    private final ImageBack boxTC;
    private final ImageBack boxTR;
    private final ImageBack boxBL;
    private final ImageBack boxBC;
    private final ImageBack boxBR;
    private final ImageButton coinImage;
    private final TextLabel coinText;
    private final ImageButton shopsImage;
    private final TextLabel shopsText;
    private final ImageButton eventsImage;
    private final TextLabel eventsText;
    private final ImageButton transfersImage;
    private final TextLabel transfersText;
    private final ImageButton waypointsImage;
    private final TextLabel waypointsText;
    private final ImageButton renderImage;
    private final TextLabel renderText;
    public MainGui() {
